...
#define FLASH_SECTOR_CLOUDS (29UL)
#define FLASH_LENGTH_CLOUDS (96000UL) // sectors: 23
#define FLASH_SECTOR_ICE_FPV_512x300 (53UL)
#define FLASH_LENGTH_ICE_FPV_512x300 (13434514UL) // sectors: 3279
//Total sectors = 4096, free sectors = 763
//Total flash = 16777216, free flash = 3125248
